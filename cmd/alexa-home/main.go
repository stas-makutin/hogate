...
var devicesFriendlyNames = map[string]string{
	"L-1":   "Office Lights",
	"L-2":   "Kitchen Over the Table Light",
	"L-3":   "Kitchen Over the Sink Light",
	"L-4":   "Kitchen Island Light",
	"L-5":   "Entrance Light",
	"L-6":   "Garage Light",
	"L-7":   "Garbage Light",
	"L-6a":  "Gate Light",
	"L-8":   "Living Room Window Light",
	"L-9":   "Living Room Fireplace Light",
	"L-10":  "Living Room Upper Light",
	"L-11":  "Backyard Light",
	"L-12":  "Shed Light",
	"L-13":  "Driveway Light",
